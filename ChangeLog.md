...
* v9.51.2 (2015-04-23)
	...
	* renamed repository to `shellparty-lib`
* v9.51.1 (2015-04-20)
...
* v9.51.0 (2015-04-01)
	...
	* deprecate `get_shp_supply()` API method in favor of `get_supply(asset)`
...
* v9.49.4 (2015-02-05)
	...
	* moved CLI to new repository: `shellparty-cli`
	...
	* prepared version check for repository rename to `shellparty-lib`
	...
	* Rename the database file name from `shellpartyd.9.db` to `shellparty.db`
	* Add SCHD support
* v9.49.3 (2014-12-28)
...
* v9.49.2 (2014-12-19)
	...
	* use python-SatoshiChainlib for RPC communication with backend
...
* v9.47.0 (2014-12-01)
	...
	* support for jmcorgan Shellcoin Core fork for block explorer
...
* v9.45.0 (2014-10-23)
	* add dividend fee of 0.0002 SHP per recipient (protocol change: 330000)
* v9.44.0 (2014-09-22)
...
* v9.42.0 (2014-09-04)
	* disable dividends to SHP holders (protocol change: 320000)
	* allow dividends only from issuers (protocol change: 320000)
* v9.41.0 (2014-08-21)
	* fixed bug in new text and descriptions
* v9.40.0 (2014-08-20)
	* allow dividends to be paid to SHP holders (protocol change: 317500)
	* fixed bug in SCHpay validation
...
* v9.37.0 (2014-08-02)
	* close sell SCH orders and order_matches of addresses that fail to make a SCH payment (protocol change: 313900)
* v9.36.0 (2014-08-02)
	* version mismatch
* v9.35.0 (2014-08-02)
	* minimum SCH order match size; don’t check source address of SCHpay (protocol change: 313900)
* v9.34.0 (2014-07-24)
...
* v9.17.0
	* failed SHP conservation sanity check on testnet (deadline checking in bets)
* v9.16.3
	* bug fixes
* v9.16.2
...
* v9.16
	* regular version, database, Shellcoind checking in API
...
* v6.14
	...
	* transaction signing for source addresses not in Shellcoin Core wallet
	* tweaks to API
* v6.13
	* miscellaneous bug fixes
	* add some sanity checks
	* partially allow for CLI input of private keys (to bypass Shellcoind wallet)
	* tweak the API
	* fill out the test suite a bit
	* temporarily double the default fee to .0002 SCH
* v6.12
* v6.11
* v6.10
* v6.9
...
* reduce issuance fee to 0.5 SHP: 291700
