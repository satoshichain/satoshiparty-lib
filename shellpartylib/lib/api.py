...
from shellpartylib.lib import transaction
from shellpartylib.lib import blocks
from shellpartylib.lib import script
from shellpartylib.lib.messages import send
from shellpartylib.lib.messages import order
from shellpartylib.lib.messages import shellpay
from shellpartylib.lib.messages import issuance
from shellpartylib.lib.messages import broadcast
from shellpartylib.lib.messages import bet
from shellpartylib.lib.messages import dividend
from shellpartylib.lib.messages import burn
from shellpartylib.lib.messages import cancel
from shellpartylib.lib.messages import rps
from shellpartylib.lib.messages import rpsresolve
from shellpartylib.lib.messages import publish
from shellpartylib.lib.messages import execute

API_TABLES = ['assets', 'balances', 'credits', 'debits', 'bets', 'bet_matches',
              'broadcasts', 'shellpays', 'burns', 'cancels',
...
API_TRANSACTIONS = ['bet', 'broadcast', 'shellpay', 'burn', 'cancel',
...
def check_database_state(db, blockcount):
    """Checks {} database to see if is caught up with backend.""".format(config.SHP_NAME)
    if util.CURRENT_BLOCK_INDEX + 1 < blockcount:
        raise DatabaseError('{} database is behind backend.'.format(config.SHP_NAME))
