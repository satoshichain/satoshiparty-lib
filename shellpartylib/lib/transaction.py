"""
Construct and serialize the Shellcoin transactions that are Shellparty transactions.
...
from SatoshiChain.core.script import CScript
from SatoshiChain.core import x
from SatoshiChain.core import b2lx
