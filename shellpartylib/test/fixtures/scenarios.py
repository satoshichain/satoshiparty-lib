...
UNITTEST_FIXTURE = [
    ...
    ['order', (ADDR[0], 'SHP', DP['quantity'], 'DIVISIBLE', DP['quantity'], 2000, 0), {'encoding': 'multisig'}],
    ['send', (ADDR[0], ADDR[1], 'DIVISIBLE', DP['quantity']), {'encoding': 'multisig'}],
    ['send', (ADDR[0], ADDR[1], 'SHP', DP['quantity']), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'SHP', DP['quantity'], 'DIVISIBLE', DP['quantity'], 2000, 0), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'SHP', DP['quantity'], 'SCH', round(DP['quantity'] / 100), 2000, DP['fee_required']), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'SCH', round(DP['quantity'] / 150), 'SHP', DP['quantity'], 2000, 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
    ['send', (ADDR[0], MULTISIGADDR[0], 'SHP', DP['quantity'] * 3), {'encoding': 'multisig'}],
    ...
    ['order', (ADDR[0], 'SHP', DP['quantity'], 'SCH', round(DP['quantity'] / 125), 2000, DP['fee_required']), {'encoding': 'multisig'}],
    ['order', (ADDR[1], 'SCH', round(DP['quantity'] / 125), 'SHP', DP['quantity'], 2000, 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
    ...
    ['send', (ADDR[2], ADDR[3], 'SHP', 92945878046), {'encoding': 'multisig'}],
...
def generate_standard_scenario(address1, address2, order_matches):
    ...
    return [
        ...
        ['send', (address1, address2, 'SHP', DP['small']), {'encoding': 'multisig'}],
        ['order', (address1, 'SCH', DP['small'], 'SHP', DP['small'] * 2, DP['expiration'], 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
        ['order', (address1, 'SHP', round(DP['small'] * 2.1), 'SCH', DP['small'], DP['expiration'], DP['fee_required']), {'encoding': 'multisig'}],
        ['shellpay', (address1, order_matches[0]), {'encoding': 'multisig'}],
        ...
        ['dividend', (address1, 600, 'BBBB', 'SHP'), {'encoding': 'multisig'}],
        ['dividend', (address1, 800, 'BBBC', 'SHP'), {'encoding': 'multisig'}],
        ...
        ['order', (address1, 'BBBB', DP['small'], 'SHP', DP['small'], DP['expiration'], 0), {'encoding': 'multisig'}],
        ['burn', (address1, (1 * DP['quantity']), True), {'encoding': 'multisig'}],  # Try to burn a whole 'nother SCH.
