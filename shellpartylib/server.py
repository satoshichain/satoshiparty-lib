...
from shellpartylib.lib import api, config, util, exceptions, blocks, check, backend, database, transaction, script, log
...
def initialise(database_file=None, log_file=None, api_log_file=None,
    ...
    if backend_user:
        ...
        config.BACKEND_USER = 'SatoshiChainrpc'
...
def kickstart(db, SatoshiChaind_dir):
    blocks.kickstart(db, SatoshiChaind_dir=SatoshiChaind_dir)
